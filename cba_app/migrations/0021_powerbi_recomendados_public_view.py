...
"""PostgreSQL view for Power BI: resultados_cba_recomendados (public format).
...
POSTGRES_CREATE = """
CREATE OR REPLACE VIEW vw_powerbi_resultados_cba_recomendados_public AS
SELECT
    id,
...
POSTGRES_DROP = "DROP VIEW IF EXISTS vw_powerbi_resultados_cba_recomendados_public"
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("cba_app", "0020_powerbi_resultados_public_view"),
    ]
